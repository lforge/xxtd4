...
// --------------- ---------- ------------------------------------------------------------------------------
// Jude Lam        04/26/2012 - Updated the paginateCollection to allow the passing of order option to the Model.all routine.
//                            - Updated the paginateHelper to add "pagination-right" to the class div setup.
// Jude Lam        05/19/2012 - Updated the paginateCollection to allow the passing of where option to the Model.all routine
//                              if one is provided.
...
function paginateHelper(collection) {
    ...
    var html = '<div class="pagination pagination-right">';
